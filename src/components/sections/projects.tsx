    ...
    <div className="relative group">
      ...
      <div className="absolute inset-0 flex items-center justify-between p-4 opacity-0 group-hover:opacity-100 transition-opacity">
        <Button
          variant="ghost"
          size="icon"
          className="h-8 w-8 rounded-full bg-slate-900/80 hover:bg-slate-800 border border-blue-500/50 hover:border-blue-500"
          onClick={scrollPrev}
        >
            ...
            className={`h-1.5 rounded-full transition-all duration-300 
              ${
                selectedIndex === dotIndex
                  ? 'w-3 bg-blue-500'
                  : 'w-1.5 bg-blue-500/50 hover:bg-blue-500'
              }`}
      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {displayedProjects.map((project, index) => (
            ...
            >
              <Card className="overflow-hidden h-full hover:shadow-lg transition-all duration-300 hover:border-blue-500/50 group bg-slate-800/50 border-blue-800/30">
                <ProjectCarousel
                  ...
                  <div className="flex flex-wrap gap-4">
                    {project.sourceCode && (
                      <Button
                        variant="outline"
                        size="sm"
                        className="flex-1 min-w-[140px] hover:bg-blue-600 hover:text-white border-blue-500/50 text-blue-400"
                        asChild
                      >
                        <a
        ...
        {PROJECTS.length > INITIAL_DISPLAY_COUNT && (
          ...
          >
            <Button
              ...
              className="group border-blue-500/50 hover:bg-blue-600 hover:text-white text-blue-400"
            >
              {showAll ? (
                <>
                  Show Less
