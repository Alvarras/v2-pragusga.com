          ...
          {skillCategories.map((category, index) => {
            ...
            return (
              <motion.div
                ...
                className="glass rounded-xl p-6 border border-blue-800/30 shadow-lg hover:shadow-xl transition-all bg-slate-800/50 w-full sm:w-[calc(50%-1.5rem)] lg:w-[calc(33.33%-1rem)] xl:w-[calc(30%-1rem)] min-w-[280px] max-w-[400px]"
              >
                ...
                <div className="grid grid-cols-2 gap-x-4">
                  ...
                  <ul className="space-y-2">
                    {leftColumnSkills.map((skill) => (
                      ...
                      >
                        <span className="w-1.5 h-1.5 rounded-full bg-blue-400/70 mr-2" />
                        {skill}
                      </li>
                    ))}
                  </ul>
